    ...
    if($num_rows>0)
    {
        while($row=mysqli_fetch_array($res))
        {
           ...
           echo "<tr>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in paper1:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['paper1'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in paper2:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['paper2'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in paper3:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['paper3'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in paper4:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['paper4'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>total_marks</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
